import torch
from ACDrepo.ACD.model.modules import *
from ACDrepo.ACD.model.Encoder import Encoder

# Encoder and Decode in model_scm2.py are originated from the below source codes

# ---------------------------------------------------------------------------
# 1. MADP\ACDrepo\ACD\model\MLPEncoder.py 
# ---------------------------------------------------------------------------
...
# ---------------------------------------------------------------------------
# 2. MADP\ACDrepo\ACD\model\MLPDecoder.py 
# ---------------------------------------------------------------------------
